...
This is how [Continuous Context](/learn/introduction#continuous-context-agents-agents-branch-inherit-and-build-on-each-others-attention-state) works for recursive tools. Sub-agents attend over the same physical key-value pairs at the parent's shared positions — no information bottleneck, no re-encoding.
